...
export const Edit = () => {
  ...
  useEffect(() => {
    dispatch(setCurrentNav("/commentary", "Edit"));
  ...
  return (
    <Styled.Container>
        ...
        <Styled.RowContent>
          ...
          <Styled.Bottom>
            <Styled.RouteLink
              ...
              to={`/commentary/edit-comment/${classOfBusiness?.id}/${classOfBusiness?.name}/${subSection1?.id}/${subSection1?.name}/${subSection2?.id}/${subSection2?.name}/${dashBoard?.id}/${dashBoard?.name}/${year}/${month}/${report?.id}/${report?.name}`}
            >
              EDIT
            </Styled.RouteLink>
          </Styled.Bottom>
      ...
      <Styled.Row>
        <Styled.RowContent>
          {showPreview ? <Instructions /> : <RecentComments viewType="view" />}
        </Styled.RowContent>
      </Styled.Row>
    </Styled.Container>
  );
