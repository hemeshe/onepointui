        ...
        {Data &&
          Data.map((ing) => (
            <T.TRow key={ing.id} borderBottom='1px solid #D9D9D9'>
              ...
              <T.TD style={{ minWidth: '200px' }}>{ing.formula}</T.TD>
              <T.TD>{ing.method}</T.TD>
              <T.TD>{ing.methodDesc}</T.TD>
              <T.TD>{ing.cob}</T.TD>
              <T.TD>{ing.site}</T.TD>
              <T.TD>{ing.allocation}</T.TD>
              <T.TD>{ing.scaleFactor}</T.TD>
              <T.TD>
                <div>
                  {
              ...
              <T.TD>{ing.negAdminMarginFlg ? 'Yes' : 'No'}</T.TD>
              <T.TD>
