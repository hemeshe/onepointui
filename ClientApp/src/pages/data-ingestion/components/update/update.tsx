        ...
        <Styled.RowContent>
          ...
          <Styled.Bottom>
            <Styled.RouteLink
              ...
              to={`/data-ingestion/update-list/${selectedCOF.name}/${selectedCOF.id}/${selectedDIF.name}/${selectedDIF.id}/${selectedYear}/${selectedQuarter}/${selectedMonth}`}
            >
              VIEW
            </Styled.RouteLink>
          </Styled.Bottom>
...
const enhancedComponent = WithIngestionHelpers(Update, 'Edit');

export { enhancedComponent as Update };
