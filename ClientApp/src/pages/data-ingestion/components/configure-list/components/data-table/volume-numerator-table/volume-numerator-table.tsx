...
import { VolumeNumeratorHeadings } from '../../../../../config-headings';
...
export const VolumeNumeratorTable: FC<Props> = memo(
  ({ ingestionData, errorFieldName }) => {
    const {
      ...
      handleRemoveAddRow,
      newIngestion,
    } = useIngestionTableHelpers(VolumeNumeratorHeadings);
    ...
    return (
      <T.Table>
        ...
        <T.TBody>
          ...
          {ingestionData && Array.isArray(ingestionData) && ingestionData.length > 0 && (
            <Texts
