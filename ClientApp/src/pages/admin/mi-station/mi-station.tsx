...
import { useMiStation } from "./hooks/useMiStation";

export const MiStation: FC = memo(() => {
  const {
    history,
    handleRefresh,
    csvData,
  ...
  const getFileName = useMemo(() => {
    if (history.location.pathname === "/admin/mi-station/history")
      return `Station-admin-history.csv`;
    else return `Mi-Station-users.csv`;
          ...
          <Styled.Top>
            <Styled.TopRight>
              ...
              {history && history.location && (
                <div>
                  {history.location.pathname === "/admin/mi-station" ||
                  history.location.pathname === "/admin/mi-station/history" ? (
                    <React.Fragment>
