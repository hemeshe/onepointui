export const Menus = [
  {
    name: 'View',
    route: '/power-bi-drls/profiles',
    privilegeRequired: 'READ',
  },
  {
    name: 'Add',
    route: '/power-bi-drls/profiles/add',
    privilegeRequired: 'WRITE',
  },
  {
    name: 'Edit',
    route: '/power-bi-drls/profiles/update',
    privilegeRequired: 'WRITE',
  },
  {
    name: 'History',
    route: '/power-bi-drls/profiles/history',
    privilegeRequired: 'READ',
  },
];
...
export const profileTypeOptions = ['New', 'Existing'];
